...
namespace NerdStore.Core
{
    public class Validacoes
    {
        ...
        public static void ValidarCaracteres(string valor, int maximo, string msg)
        {
        ...
        public static void ValidarCaracteres(string valor, int minimo, int maximo, string msg)
        {
            var length = valor.Trim().Length;
        ...
        public static void ValidarSeMenorOuIgualAoMinimo(double valor, double minimo, string mensagem)
        {
            if (valor <= minimo)
                throw new DomainException(mensagem);
        }

        public static void ValidarSeMenorOuIgualAoMinimo(decimal valor, decimal minimo, string mensagem)
        {
            if (valor <= minimo)
                throw new DomainException(mensagem);
        }

        public static void ValidarSeMenorOuIgualAoMinimo(int valor, int minimo, string mensagem)
        {
            if (valor <= minimo)
                throw new DomainException(mensagem);
        }
